...
　OFFにするとMIDIのVelocity（通常は音の強さ）ではなく、音符の長さ全体で鳴らします。

#### CHORD分離
　OFFでは、音のつながりを重視してCH1,CH3～CH6を巡回するように音を割り振ります。

　ONにするとMelodyと判断した音をCH1に割り振り、CHORDと判断した音をCH3～CH6に割り振ります。

#### 主旋律優先(Melody Priority)
　同時に鳴る音が5物理CHを超える場合に、高い音を主旋律候補として優先的に残す機能です。

　CMU-800は5物理CHあるので最大5重和音出せますが、複数のパートや伴奏がある曲で5音以上の音を同時に鳴らす必要がある場合に高い音の方が主旋律だろうと判断します。

　ただし、最高音だから主旋律とは限りませんので万能ではありません。

　CHORD分離がONの場合は、CH1に割り振られた音だけで判断します。
